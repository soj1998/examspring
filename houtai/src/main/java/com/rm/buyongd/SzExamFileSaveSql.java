...
public class SzExamFileSaveSql {
	...
	public void saveExamChoi(SaveServiceImpl examQueService, ExamQue examQue, Map<Integer,String> map) {
	...
	public void saveExamDaan(SaveServiceImpl examQueService, ExamQue examQue, Map<Integer,String> map) {
		try{
	...
	public boolean getpanDuanXuanXiang(JSONArray crArray,String[] danxuan) {
		boolean rs= false;
		boolean tc = false;
		for (Object fd:crArray) {
			JSONObject jb = (JSONObject)fd;
	...
	public void asoneinsertToSql(FindServiceImpl findService,SaveServiceImpl examQueService,
